...
function adventureSelector(num) {
  if(num===1){return function(){ console.log("You selected the Vines of Doom!");}}
  if(num===2){return function(){ console.log("Looks like you want the Lake of Despair!");}}
  if(num===3){return function(){ console.log("The Caves of Catastrophe!");}}
